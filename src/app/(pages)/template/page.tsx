...
const page = () => {
  ...
  const firstHeading = splitStringUsingRegex("Segera Hadir");
    ...
    >
      <section className="relative w-full min-h-screen flex flex-col justify-center items-center gap-10 py-28">
        <motion.h1
          ...
          viewport={{ once: true }}
        >
          <div className="overflow-hidden font-helveticaLight text-[2.5rem] leading-8 sm:text-7xl lg:text-8xl pb-2">
