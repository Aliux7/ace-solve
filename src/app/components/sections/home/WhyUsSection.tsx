      ...
      <ul className="w-full my-5">
        <li>
          <TextBoxReveal width="full">
            <div className="w-full border-y px-3 lg:px-5 py-5 md:py-7 flex flex-col-reverse sm:flex-row justify-start items-center gap-6 sm:gap-6 md:gap-14 lg:gap-20 xl:gap-32 hover:border-y-purple-300 hover:bg-purple-100 transition-all duration-300 ease-in-out">
